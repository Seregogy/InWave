...
- Подборка топ треков по артистам на главном экране
- Профили пользователей с понравившимися треками и релизами
- Анимированная волна под музыку, которая подстраивается под цвет обложки текущего трека
- Endless плеер с постоянной подгрузкой треков
